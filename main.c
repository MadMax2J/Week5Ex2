...
void displayDataToUser(int frequencyDistributionDataArray[5]);
...
int main() {
    ...
    displayDataToUser(frequencyDistribution);
...
void displayDataToUser(int frequencyDistributionDataArray[5]) {
    ...
    puts("\n");
    puts("\n Histogram showing Distribution of windspeeds on 22nd September 2013");
...
void categorizeData(float sourceDataArray[],
    ...
    ////TESTING
    printf("The min data was %f and the MAX data was %f.\n\n\n", min, max);
